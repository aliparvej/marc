...
<html>
    ...
    <body>
        ...
        <div class="txtb">
            <input type="email" name="email" placeholder="Email" autocomplete="off" required style="font-size:20px;">
            
        </div>
        <div class="txtb">
            <input type="password" name="password" placeholder="Password" autocomplete="off" required style="font-size:20px;"/>
